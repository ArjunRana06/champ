...
<head>
    ...
    <title>Reset Password | Life Replay</title>
    ...
    <div class="forgot-wrapper">
        ...
        <div class="hero-panel">
            ...
            <div class="testimonial">
                “Quick and secure — I got my reset link instantly and was back replaying my timeline in minutes.”
                <div class="testimonial-author">— Michael, early user</div>
            </div>
        </div>
        ...
        <div class="form-panel">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="hello@life.com">
                    @error('email')
