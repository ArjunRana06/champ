...
<head>
    ...
    <title>Reset Password · Study Assistant for Students</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-link { display: block; text-align: center; margin-top: 1.5rem; font-size: 0.85rem; }
        ...
        <div class="hero-panel">
            <div>
                ...
                <div class="tagline">
                    ...
                    <p>Enter your email and we'll send you a link to reset your password securely.</p>
                </div>
                <div class="stats">
            ...
            <div class="testimonial">
                “Quick and secure — I got my reset link instantly and was back to studying in minutes.”
                <div class="testimonial-author">— Michael, CS student</div>
            </div>
        </div>
        ...
        <div class="form-panel">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="student@example.com">
                    @error('email')<span class="error">{{ $message }}</span>@enderror
                </div>
                <button type="submit" class="btn-submit">Send reset link <i class="fas fa-arrow-right text-sm"></i></button>
