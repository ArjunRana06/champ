    ...
    <div class="wrapper">
        <div class="hero-panel">
            ...
            <div class="testimonial">
                “Password reset was quick and hassle-free. I was back to studying in no time.”
                <div class="testimonial-author">— Emma, Data Science student</div>
            </div>
        </div>
        ...
        <div class="form-panel">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" placeholder="student@example.com">
                ...
                <div class="flex justify-end mt-6">
                    <button type="submit" class="btn-submit">Reset password <i class="fas fa-arrow-right text-sm"></i></button>
                </div>
            </form>
        </div>
    </div>
