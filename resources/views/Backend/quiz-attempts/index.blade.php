            ...
            <table class="glass-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span style="font-size:0.7rem;padding:0.15rem 0.6rem;border-radius:20px;background:#eef2ff;color:var(--card-accent);">{{ $attempt->type }}</span></td>
                        <td>
                    ...
                    @empty
                    <tr><td colspan="6" style="text-align:center;color:var(--text-muted);padding:2rem;">No quiz attempts yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
