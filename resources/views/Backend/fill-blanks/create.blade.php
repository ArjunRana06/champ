...
<div class="container" style="max-width:650px;">
    <div class="glass-card p-4" data-aos="fade-up">
        <h2 style="color:var(--text-primary);font-weight:800;font-size:1.3rem;margin-bottom:0.25rem;">
            <i class="bi bi-input-cursor-text me-2" style="color:var(--card-accent);"></i> Generate Fill-in-the-Blank Questions
        </h2>
        <p style="color:var(--text-secondary);font-size:0.88rem;margin-bottom:1.5rem;">Create fill-in-the-blank practice questions from your study materials using AI.</p>

        <form action="{{ route('fill-blanks.generate') }}" method="POST" class="form-glass">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="topic" class="form-control" placeholder="e.g., Grammar, Anatomy, Physics Laws">
