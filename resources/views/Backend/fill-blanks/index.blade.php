...
<script>
    ...
    function confirmDeleteAll() {
        if (confirm('Delete ALL your fill-in-the-blank questions? This cannot be undone.')) {
...
@endforeach
<form id="delete-all-form" action="{{ route('fill-blanks.delete-all') }}" method="POST" style="display:none;">@csrf @method('DELETE')</form>
@endsection
