...
<script>
    ...
    function confirmDeleteAll() {
        if (confirm('Delete ALL your matching questions? This cannot be undone.')) {
...
@endforeach
<form id="delete-all-form" action="{{ route('matching.delete-all') }}" method="POST" style="display:none;">@csrf @method('DELETE')</form>
@endsection
