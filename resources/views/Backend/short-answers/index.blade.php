                ...
                <div class="glass-card h-100 position-relative" id="card-{{ $question->id }}">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <div class="d-flex gap-1">
                            <a href="{{ route('short-answers.edit', $question) }}" class="btn-soft py-1 px-2" style="font-size:0.75rem;color:var(--card-accent);">
                    ...
                    <p style="color:var(--text-primary);font-weight:600;font-size:0.95rem;margin-bottom:1rem;">{{ $question->question }}</p>
        ...
        @empty
            <div class="col-12">
                <div class="glass-card text-center py-5">
                    ...
                    <p class="mt-3" style="color:var(--text-secondary);">No short answer questions generated yet. Click "Generate New" to create some from your notes.</p>
...
<script>
    ...
    function confirmDeleteAll() {
        if (confirm('Delete ALL your short answer questions? This cannot be undone.')) {
...
@endforeach
<form id="delete-all-form" action="{{ route('short-answers.delete-all') }}" method="POST" style="display:none;">@csrf @method('DELETE')</form>
@endsection
